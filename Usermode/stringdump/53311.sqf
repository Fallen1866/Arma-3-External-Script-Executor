#line 0 "/temp/bin/A3/Functions_F/Strategic/fn_strategicMapOpen.sqf"
...
_parentDisplayDefault = switch false do {
	case isnull (finddisplay 37): {finddisplay 37}; 
	case isnull (finddisplay 52): {finddisplay 52}; 
	case isnull (finddisplay 53): {finddisplay 53}; 
