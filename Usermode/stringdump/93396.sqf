#line 0 "/temp/bin/A3/Functions_F/Effects/fn_effectFiredSmokeLauncher_boat.sqf"
...
if (_num>0) then
{
	...
	_deltaDir = _angle/_num;			
	_arc = _deltaDir*(_num-1);		
	...
	for "_i" from 0 to (_num - 1) do
	{
		...
		_Hdir = ((_i*_deltaDir)+_dir) - _arc/2; 


		_Gvel = [_vH *sin(_Hdir), _vH*cos (_Hdir), _vV]; 

		
		_pH = _initDist * cos _Vdir;     
		_pV = _initDist * sin _Vdir;     
