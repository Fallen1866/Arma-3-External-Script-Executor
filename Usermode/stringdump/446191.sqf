...
private _ctrlListTextures = _display displayctrl (			960 + 		20);
...
_ctrlList = _display displayctrl (			960 + 		19);
for "_i" from 0 to (lbsize _ctrlList - 1) do {
if (random 1 > 0.5) then {_ctrlList lbsetcursel _i;};
};


_ctrlList = _display displayctrl (			960 + 		20);
...
_ctrlList = _display displayctrl (			960 + (floor random (count [					0,					1,					2,					3,					4,					5] - 1)));
