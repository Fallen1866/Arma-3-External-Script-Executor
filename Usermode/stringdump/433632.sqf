	...
	private _fnc_scriptNameParent = if (isNil '_fnc_scriptName') then {'BIS_fnc_WLSmoothText'} else {_fnc_scriptName};
	private _fnc_scriptName = 'BIS_fnc_WLSmoothText';
	scriptName _fnc_scriptName;

#line 1 "A3\Functions_F_Warlords\Misc\fn_WLSmoothText.sqf [BIS_fnc_WLSmoothText]"
#line 1 "A3\Functions_F_Warlords\Misc\fn_WLSmoothText.sqf"
